    ...
    <div className="text-center">
      <div
        className={classNames(
          ...
          !onModal &&
            "w-auto max-w-4xl lg:max-w-6xl h-[500px] mx-auto shadow-mainShadow"
        )}
      >
        {/* post container */}
        <div className="flex h-full w-full">
            ...
            <div className="bg-black h-full flex items-center">
              <figure className={`w-full ${post.data()?.imageFilter}`}>
                <Image
                  ...
                  alt="post image"
                  className={classNames(
                    "object-contain w-full min-w-[250px]",
                    onModal ? "max-h-[90%]" : "h-[100%] w-auto"
                  )}
                />
              </figure>
            </div>
          ...
          <div
            className={classNames(
              ...
              !onModal && "min-w-[340px] max-w-[350px]",
              onModal && "max-w-[400px] min-w-[380px]"
            )}
          >
            <div id="emojiPicker">
              {showPicker && (
                ...
                <>
                  <div className="flex items-center">
                    ...
                    >
                      <img
                        src={
                          post?.data()?.userImage ?? "/images/placeholder.png"
                        }
                        alt="post user image"
                      ...
                      {post?.data()?.userId !== session.user.id &&
                        (follows ? (
                          ...
                          <>
                            ...
                            <button
                              onClick={follow}
                              className="text-instaBlue font-[600]"
                            >
                              Follow
                            </button>
                          </>
            ...
            <section className="border-t">
              ...
              {/* comment input */}
              <form
                className="flex items-center border-t py-3 px-5"
