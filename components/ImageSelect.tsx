...
const ImageSelect = ({
  ...
  return (
    <>
      <header className="text-center p-5 font-bold text-lg border-b border-solid border-b-gray-200">
        Create New Post
      </header>
      <div>
        <div className="flex justify-center items-center flex-col py-10 mb-10">
          ...
          <button
            className="bg-instaBlue text-white font-bold py-2 px-5 rounded-md"
