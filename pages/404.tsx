...
const NotFound = () => {
  ...
  return (
    ...
    >
      <h1 className="mb-16 bg-gray-700 px-7 py-3 rounded-full text-lg font-bold text-gray-100">
        Page Not Found
      </h1>
      ...
      <button
        className="py-5 mt-10 font-[600] hover:border-instaBlue hover:bg-instaBlue/10
