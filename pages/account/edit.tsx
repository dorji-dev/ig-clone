...
const EditProfile = () => {
  ...
  return (
    <div className="pb-24">
      ...
      {/* edit form */}
      <form
        className="py-12 bg-white shadow-mainShadow rounded-bl-lg rounded-br-lg mx-3 md:max-w-[70%] md:mx-auto"
      ...
      >
        <div className="flex px-5 md:px-10 md:justify-center items-center mb-8">
          ...
          <div className="editDiv">
            ...
            <button
              onClick={() => openModal(true)}
              className="font-bold text-instaBlue"
            >
        ...
        <div className="editWrapper">
          ...
          <div className="editDiv">
            <textarea
              className="focus:border-instaBlue"
              placeholder="Bio"
              id="bio"
              cols={30}
            />
        ...
        <div className="editWrapper">
          ...
          <div className="editDiv">
            <h1 className="text-lg font-bold text-gray-400 mt-3">
        ...
        <div className="flex px-5 md:px-10">
          ...
          <div className="editDiv">
            <button
              className="px-5 py-2 bg-instaBlue text-white font-[600] rounded-md"
              type="submit"
            >
              Submit
            </button>
