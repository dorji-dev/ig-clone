...
const Features = () => {
  return (
    <div
      className="bg-white mb-20 sm:shadow-mainShadow h-full sm:h-auto sm:rounded-lg 
    ...
    >
      ...
      <section className="mb-7">
        <h2 className="text-lg text-gray-600 font-bold mb-3">
          Current Features
        </h2>
        <ul className="text-[#334155]">
          {currentFeatures.map((feature, idx) => (
            <li
              key={idx}
              className="pl-4 relative before:content-[''] before:h-[5px] before:w-[5px] before:bg-gray-500
