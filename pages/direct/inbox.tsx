          ...
          {false ? (
            ...
            <>
              ...
              <section className="grow flex flex-col items-center justify-center px-10 text-center mt-10 text-gray-500">
                ...
                <p>
                  Feature <span className="font-bold">coming soon!</span> You
                  can still play with the UI though.
                </p>
              </section>
            </>
          )}
          ...
          <Right>
            {false ? (
              ...
              <div className="flex flex-col justify-center items-center h-full">
                <div
                  className="w-[96px] h-[96px] border-2 border-black rounded-full flex 
                                            justify-center items-center mb-4"
                >
                  <FiSend
                    className="rotate-[20deg] relative -left-1"
                    size={44}
                  />
                </div>
                ...
                <button
                  ...
                  className="px-4 py-2 bg-instaBlue text-white rounded-md font-bold"
                >
                  Send Message
                </button>
              </div>
